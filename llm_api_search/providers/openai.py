...
_STATIC_MODELS = [
    ...
    TextModelInfo(
        ...
        description='Balanced GPT-5.4 model for cost-sensitive workloads. Image input supported; no audio/video. Cached input $0.075/1M.',
        context_window=400_000,
        max_output_tokens=128_000,
        supports_vision=True,
        supports_tool_use=True,
    ...
    TextModelInfo(
        ...
        description='Smallest, fastest GPT-5.4 model for cost-sensitive, high-volume tasks. Image input supported; no audio/video. Cached input $0.02/1M.',
        context_window=400_000,
        max_output_tokens=128_000,
        supports_vision=True,
        supports_tool_use=True,
    ...
    TextModelInfo(
        ...
        description='Frontier model for complex professional work; flagship of the GPT-5.6 family (the gpt-5.6 alias routes here)',
        context_window=1_050_000,
        max_output_tokens=128_000,
        supports_vision=True,
        supports_tool_use=True,
