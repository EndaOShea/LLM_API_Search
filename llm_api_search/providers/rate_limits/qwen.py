...
Verified: 2026-07-20
qwen3.5-plus / qwen3.6-plus: https://www.qwencloud.com/models/<model_id>
(verified 2026-08-04); qwen3.8-max from the same page format (verified 2026-09-15)

DashScope publishes flat per-model defaults for the international region
(not spend-tiered like Kimi), so each model is exposed under a single
...
RATE_LIMITS: dict[str, dict[str, RateLimit]] = {
    "qwen3.8-max": {
        "default": RateLimit(requests_per_minute=15_000, tokens_per_minute=2_000_000),
    },
    "qwen3.7-max": {
