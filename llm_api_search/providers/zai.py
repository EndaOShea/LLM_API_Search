...
_STATIC_MODELS = [
    ...
    TextModelInfo(
        ...
        description='GLM-4.5 text model. 128K token context, up to 96K output. Tool calling and configurable thinking.',
        context_window=128_000,
        max_output_tokens=96_000,
        supports_vision=False,
        supports_tool_use=True,
    ...
    TextModelInfo(
        ...
        description='GLM-4.7 text model. 200K token context, up to 128K output. Tool calling and configurable thinking.',
        context_window=200_000,
        max_output_tokens=128_000,
        supports_vision=False,
        supports_tool_use=True,
    ...
    TextModelInfo(
        ...
        description='GLM-5-Turbo, optimized for agentic tool invocation, instruction following, and long-chain execution. 200K token context, up to 128K output. Tool calling.',
        context_window=200_000,
        max_output_tokens=128_000,
        supports_vision=False,
        supports_tool_use=True,
    ...
    TextModelInfo(
        ...
        description='Low-cost GLM-5.3 variant with native multimodal input (images, video, files). 1M token context, up to 128K output. Tool calling and always-on thinking (reasoning_effort). List price shown; a 50% promotional discount ($0.075/$0.25 per Mtok) runs until 2026-09-09 (UTC+8).',
        context_window=1_000_000,
        max_output_tokens=128_000,
        supports_vision=True,
        supports_tool_use=True,
