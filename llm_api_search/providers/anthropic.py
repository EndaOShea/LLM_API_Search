...
_STATIC_MODELS = [
    ...
    TextModelInfo(
        ...
        description='For demanding reasoning and long-horizon agentic work. Adaptive thinking is always on, default effort high. Cache hits cost 0.025x base input, not the usual 0.1x.',
        context_window=1_000_000,
        max_output_tokens=128_000,
        supports_vision=True,
        supports_tool_use=True,
    ...
    TextModelInfo(
        ...
        description='For complex agentic coding and enterprise work; deep reasoning and long-horizon agentic execution. Thinking is on by default (disabling it is only allowed at effort high or below). Separate rate-limit bucket from the combined Opus 4.x pool.',
        context_window=1_000_000,
        max_output_tokens=128_000,
        supports_vision=True,
        supports_tool_use=True,
    ...
    TextModelInfo(
        ...
        description='The best combination of speed and intelligence. The $2/$10 per Mtok launch price is now the standard price; the scheduled Sept 1, 2026 increase to $3/$15 was cancelled.',
        context_window=1_000_000,
        max_output_tokens=128_000,
        supports_vision=True,
        supports_tool_use=True,
